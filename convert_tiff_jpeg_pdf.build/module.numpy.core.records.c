...
static PyObject *impl_numpy$core$records$$$function__8___getattribute__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_3:;
    {
...

        {
            ...
            tmp_assign_source_3 = impl___main__$$$function__1_complex_call_helper_star_list(tstate, dir_call_args);
        }
        if (tmp_assign_source_3 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
static PyObject *impl_numpy$core$records$$$function__14___getattribute__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    try_end_3:;
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1};
            tmp_assign_source_4 = impl___main__$$$function__1_complex_call_helper_star_list(tstate, dir_call_args);
        }
        if (tmp_assign_source_4 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
static PyObject *impl_numpy$core$records$$$function__18_field(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_2:;
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1};
            tmp_assign_source_5 = impl___main__$$$function__1_complex_call_helper_star_list(tstate, dir_call_args);
        }
        if (tmp_assign_source_5 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
        ...
        tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[196], tmp_dictset_value);
        assert(!(tmp_res != 0));
        tmp_dictset_value = mod_consts[197];
        tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[166], tmp_dictset_value);
        assert(!(tmp_res != 0));
        tmp_dictset_value = mod_consts[65];
        tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[198], tmp_dictset_value);
        assert(!(tmp_res != 0));
        {
            ...
            tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[200], tmp_dictset_value);
        ...
        }
        {
            ...
            tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[5], tmp_dictset_value);
            Py_DECREF(tmp_dictset_value);
            assert(!(tmp_res != 0));
        }
        ...
        tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[6], tmp_dictset_value);
        Py_DECREF(tmp_dictset_value);
        assert(!(tmp_res != 0));
        ...
        tmp_res = PyDict_SetItem(locals_numpy$core$records$$$class__1_format_parser_89, mod_consts[7], tmp_dictset_value);
        Py_DECREF(tmp_dictset_value);
        assert(!(tmp_res != 0));
        // Tried code:
        // Tried code:
        {
            ...
            PyTuple_SET_ITEM0(tmp_args_value_1, 1, tmp_tuple_element_1);
            tmp_tuple_element_1 = locals_numpy$core$records$$$class__1_format_parser_89;
            PyTuple_SET_ITEM0(tmp_args_value_1, 2, tmp_tuple_element_1);
            CHECK_OBJECT(tmp_class_creation_1__class_decl_dict);
            tmp_kwargs_value_1 = tmp_class_creation_1__class_decl_dict;
            frame_c9835151ee9bdfba469e4fbeeebf6a10->m_frame.f_lineno = 89;
