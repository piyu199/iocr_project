...
static PyObject *impl_numpy$core$overrides$$$function__4_array_function_dispatch$$$function__2_decorator(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        branch_yes_3:;
        {
            ...
            if (par_implementation != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[27]) == false) {
            ...
            if (var_source != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[38]) == false) {
                    CLEAR_ERROR_OCCURRED(tstate);
                }
            }
            ...
            if (var_source_object != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[39]) == false) {
                    CLEAR_ERROR_OCCURRED(tstate);
                }
            }
            ...
            if (var_scope != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[40]) == false) {
                    CLEAR_ERROR_OCCURRED(tstate);
                }
            }
            ...
            if (self->m_closure[0]->ob_ref != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[25]) == false) {
                    CLEAR_ERROR_OCCURRED(tstate);
                }
            }
            ...
            if (self->m_closure[1]->ob_ref != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[23]) == false) {
                    CLEAR_ERROR_OCCURRED(tstate);
                }
            }
            ...
            if (self->m_closure[2]->ob_ref != NULL) {
                ...
                if (DICT_REMOVE_ITEM(tmp_assign_source_6, mod_consts[17]) == false) {
                    CLEAR_ERROR_OCCURRED(tstate);
                }
            }
    ...
    }
    {
        ...
        tmp_assign_source_8 = DICT_GET_ITEM_WITH_ERROR(tstate, tmp_dict_arg_value_1, tmp_key_value_1);
