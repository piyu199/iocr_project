...
static void createModuleCodeObjects(void) {
    ...
    codeobj_740bf4d0190a289c8a7af859115692d1 = MAKE_CODE_OBJECT(module_filename_obj, 40, CO_GENERATOR | CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[14], mod_consts[14], mod_consts[164], NULL, 1, 0, 0);
...
static PyObject *scipy$integrate$_ivp$common$$$function__3_warn_extraneous$$$genexpr__1_genexpr_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    }
    {
        ...
        tmp_expression_value_1 = PyUnicode_Join(mod_consts[13], tmp_string_concat_values_1);
        Py_DECREF(tmp_string_concat_values_1);
        if (tmp_expression_value_1 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
static PyObject *impl_scipy$integrate$_ivp$common$$$function__4_validate_tol(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
        ...
        tmp_mult_expr_right_1 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$_ivp$common, (Nuitka_StringObject *)mod_consts[18]);

        if (unlikely(tmp_mult_expr_right_1 == NULL)) {
            tmp_mult_expr_right_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[18]);
        }
    ...
    branch_yes_1:;
    {
        ...
        tmp_string_concat_values_1 = MAKE_TUPLE_EMPTY(3);
        {
            ...
            tmp_mult_expr_right_2 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$_ivp$common, (Nuitka_StringObject *)mod_consts[18]);
    ...
    }
    {
        ...
        tmp_mult_expr_right_3 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$_ivp$common, (Nuitka_StringObject *)mod_consts[18]);

        if (unlikely(tmp_mult_expr_right_3 == NULL)) {
            tmp_mult_expr_right_3 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[18]);
        }
...
static PyObject *impl_scipy$integrate$_ivp$common$$$function__10_num_jac(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_2:;
    {
        ...
        tmp_pow_expr_left_1 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$_ivp$common, (Nuitka_StringObject *)mod_consts[18]);

        if (unlikely(tmp_pow_expr_left_1 == NULL)) {
            tmp_pow_expr_left_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[18]);
        }
...
static PyObject *impl_scipy$integrate$_ivp$common$$$function__11__dense_num_jac(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        tmp_call_result_1 = CALL_METHOD_WITH_SINGLE_ARG(tstate, tmp_called_instance_4, mod_consts[16], tmp_args_element_value_11);
        if (tmp_call_result_1 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
    ...
    }
    {
        ...
        tmp_call_result_2 = CALL_METHOD_WITH_SINGLE_ARG(tstate, tmp_called_instance_7, mod_consts[16], tmp_args_element_value_22);
        if (tmp_call_result_2 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
static PyObject *impl_scipy$integrate$_ivp$common$$$function__12__sparse_num_jac(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        tmp_call_result_1 = CALL_METHOD_WITH_SINGLE_ARG(tstate, tmp_called_instance_7, mod_consts[16], tmp_args_element_value_16);
        if (tmp_call_result_1 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
    ...
    }
    {
        ...
        tmp_call_result_2 = CALL_METHOD_WITH_SINGLE_ARG(tstate, tmp_called_instance_13, mod_consts[16], tmp_args_element_value_35);
        if (tmp_call_result_2 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_pow_expr_left_2 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$_ivp$common, (Nuitka_StringObject *)mod_consts[18]);

        if (unlikely(tmp_pow_expr_left_2 == NULL)) {
            tmp_pow_expr_left_2 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[18]);
        }
    ...
    }
    {
        ...
        tmp_pow_expr_left_3 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$_ivp$common, (Nuitka_StringObject *)mod_consts[18]);

        if (unlikely(tmp_pow_expr_left_3 == NULL)) {
            tmp_pow_expr_left_3 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[18]);
        }
